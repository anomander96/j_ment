...
/**
 * Base exception for all service exceptions thrown by ProductsAPI
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class ConsoleAppException extends com.amazonaws.SdkBaseException implements BaseException {
    ...
    /**
     * Constructs a new ConsoleAppException with the specified error message.
     *
     * @param message
    ...
    @Override
    public ConsoleAppException sdkHttpMetadata(SdkErrorHttpMetadata sdkHttpMetadata) {
